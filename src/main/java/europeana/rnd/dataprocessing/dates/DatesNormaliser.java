...
public class DatesNormaliser {
	...
	/**
	 * if true, the normaliser attempts to fix dates that are invalid because the
	...
	/**
	 * @param validateAndFix       if true, the normaliser attempts to fix dates
	 *                             that are invalid because the end date is earlier
	 *                             than the start date
	 * @param trySwitchingDayMonth if true, the normaliser attempts to fix dates
	 *                             that are invalid because the end date is earlier
	 *                             than the start date
	 */
