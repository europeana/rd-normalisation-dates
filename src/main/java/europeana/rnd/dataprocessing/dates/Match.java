...
/**
 * a data class that contains the result of a normalisation. It contains the
 * pattern that was matched, if some cleaning was done, and the normalised value
 * (if successfully normalised).
 *
 */
public class Match {
	MatchId matchId;
